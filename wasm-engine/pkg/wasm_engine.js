...
export class Universe {
     ...
     * @param {number} width
     * @param {number} height
     * @param {boolean} wrap_edges
     * @param {number} birth_mask
     * @param {number} survival_mask
     */
    constructor(width, height, wrap_edges, birth_mask, survival_mask) {
        const ret = wasm.universe_new(width, height, wrap_edges, birth_mask, survival_mask);
     ...
     */
    len() {
        const ret = wasm.universe_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    clear() {
     ...
     */
    randomize(density) {
        wasm.universe_randomize(this.__wbg_ptr, density);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     */
    set_cell(x, y, alive) {
        wasm.universe_set_cell(this.__wbg_ptr, x, y, alive);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    toggle_cell(x, y) {
        wasm.universe_toggle_cell(this.__wbg_ptr, x, y);
    }
    step() {
        wasm.universe_step(this.__wbg_ptr);
    }
}
