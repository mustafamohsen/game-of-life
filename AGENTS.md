...
- `.agents/AGENTS.md` — owns project-local agent skills and workflow material.
- `src/AGENTS.md` — owns the TypeScript/Vite frontend source, UI, styles, engine adapters, patterns, and tests.
- `wasm-engine/AGENTS.md` — owns the Rust WebAssembly engine source and generated wasm package artifacts.
